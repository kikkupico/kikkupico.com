...
["I 'Accept All' always, I don't read the diffs anymore."](https://x.com/karpathy/status/1886192184808149383) That's Andrej Karpathy in February 2025 — former Director of AI at Tesla, OpenAI co-founder, one of the handful of people alive who helped design the systems he just admitted to not reviewing.
...
[Anthropic's own blog](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) used the phrase "effectively wrangling LLMs." An O'Reilly book on prompt engineering invented the job title "dedicated LLM wranglers." The metaphors of supervision are everywhere.
...
[GitClear's analysis](https://www.gitclear.com/coding_on_copilot_data_shows_ais_downward_pressure_on_code_quality) of 211 million lines of code from 2020 to 2024 found refactoring dropped from 25% to under 10% of commits, duplication increased fourfold, and churn nearly doubled. The pattern is consistent with what you'd expect when a supervision model quietly collapses into no supervision at all.
